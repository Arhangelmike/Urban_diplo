...
Посмотрим как измениться отображение данных на графике с использованием библиотеки более высокого уровня, но основанная на matplotlib в варианте все пары валют.
...
Для более читаемого вида графика внесем изменения - уменьшим размер точки, соуратим число пар до 10, поменяем вид маркера (что при маленьком значении размера добавит насыщенности графику)
