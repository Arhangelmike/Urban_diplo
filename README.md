...
Также приведу графики типа violinplot и boxplot хотя они и для даного набора данных и не столь информативны.

![seab_violin](https://github.com/user-attachments/assets/bcdad474-7566-497e-80ff-401e3facebc2)

![seab_violin2](https://github.com/user-attachments/assets/ec5f222e-d6e7-46e5-9487-b64ea6afcf4f)

Достаточно информативно смотриться постреонный по текущему набору данных график типа heatmap, приведен график без корреляции


![seab_heatmap](https://github.com/user-attachments/assets/b5fa7572-5405-45c0-aa7a-d8feb8d66507)
