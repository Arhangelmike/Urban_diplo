...
Возьммем другой тип графика диаграмму рассеивания scatter. Для более читаемого вида графика внесем изменения - уменьшим размер точки, сократим число пар до 10, поменяем вид маркера (что при маленьком значении размера добавит насыщенности графику)
